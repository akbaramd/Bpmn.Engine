    ...
    INotificationHandler<ErrorRaisedEvent>
{
    ...
    /// </summary>
    public async Task Handle(TokenMovedEvent notification, CancellationToken ct)
    {
    ...
    /// </summary>
    public async Task Handle(TokenCompletedEvent notification, CancellationToken ct)
    {
    ...
    /// </summary>
    public async Task Handle(TokenTerminatedEvent notification, CancellationToken ct)
    {
        await CancelAllSubscriptionsForTokenAsync(notification.TokenId, ct);
    }
    ...
    /// </summary>
    public async Task Handle(ErrorRaisedEvent notification, CancellationToken ct)
    {
        ...
        await _uow.ExecuteInTransactionAsync(async txCt =>
        {
            ...
            BoundarySubscription? matchedSubscription = null;
    ...
    /// </summary>
    private Task HandleUnhandledErrorAsync(
        Process process,
        Token token,
    ...
    /// </summary>
    private async Task CreateSubscriptionsForElementAsync(
        Process process,
        Token token,
        string elementId,
        ...
        CancellationToken ct)
    {
        ...
        foreach (var boundaryEvent in boundaryEvents)
        {
            ...
            var subscription = new BoundarySubscription(
                process.Id,
                token.Id,
                elementId,
                boundaryEvent.id!,
    ...
    /// </summary>
    private async Task CancelSubscriptionsForElementAsync(
        Guid processId,
        Guid tokenId,
        string elementId,
        CancellationToken ct)
    ...
    /// </summary>
    private async Task CancelAllSubscriptionsForTokenAsync(Guid tokenId, CancellationToken ct)
    {
