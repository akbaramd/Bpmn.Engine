...
[XmlRoot(ElementName = "formalExpression", Namespace = "http://www.omg.org/spec/BPMN/20100524/MODEL",
    IsNullable = false)]
public partial class BpmnFormalExpression : BpmnExpression
{
    ...
    {
        get { return evaluatesToTypeRefField; }
        set { evaluatesToTypeRefField = value; }
    }
